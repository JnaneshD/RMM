...
func (d *Dispatcher) Dispatch(clientID, command, shellType, jobDir string) (domain.Job, error) {
	...
	if d.jobRepo != nil {
		var err error
		job, err = d.jobRepo.Create(context.Background(), clientID, command, shellType, jobDir)
		if err != nil {
